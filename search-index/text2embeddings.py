...
def get_text_from_document_dict(
    ...
    """Get the text, ID, coordinates and page number from each text block in a .json file created from a `Document` object.

    A string is created for a text block by removing unnecessary styling elements, and removing semantically irrelevant 
    content from list types.
