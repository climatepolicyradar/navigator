    ...
    <section>
      <div className="text-content px-4 container mb-12">
        ...
        <p>
          ...
          at the <ExternalLink url="https://www.lse.ac.uk/">London School of Economics and Political Science</ExternalLink>. For this reason, this methodology page is substantially
          influenced by the methodology for the <ExternalLink url="https://climate-laws.org/methodology-legislation">CCLW database</ExternalLink>; please refer to that document for
          a full account of the scope of this database, and the terminology used.
        </p>
        <h2>Scope</h2>
        <p>
          Our dataset comprises national-level law and policy documents which pertain directly to policy issues concerning climate change mitigation, adaptation, loss and damage or
          disaster risk management. Documents in the database must have full legal force, having passed through the legislature or through an executive decision-making body, and/or
          set out a current governmental policy objective or set of objectives.
        </p>
        <p>
          The corpus of law and policy documents covers all parties to the UN Framework Convention on Climate Change (UNFCCC) — 196 countries plus the European Union — as well as a
          number of territories which are not party to the UN or UNFCCC — namely Taiwan, Palestine and Western Sahara.
        </p>
        <ul>
          <li className="italic">
        ...
        <p>
          The database is continually monitored and updated by teams of experts at Climate Policy Radar and at the LSE Grantham Research Institute, in order to ensure accuracy and
          to reflect the latest developments in climate law and policy. These updates are drawn from official sources such as government websites and parliamentary records.
        </p>
        <ul>
          <li className="italic">
            <span className="font-semibold">Glimpse into the future:</span> Frequent updates are planned to incorporate new types of data — including subnational laws and policies
            and documents submitted to the UNFCCC — which will be collected from new sources, including a range of databases and aggregators.{" "}
          </li>
        </ul>
        ...
        <p>
          ...
          legislative or executive - and in some cases they are not - for example, one document may be relevant to multiple sectors. Equally, not all attributes are assigned to all
          documents: some documents have no sector tags.
        </p>
        ...
        <div className="m-table">
          ...
          <div className="row">
            ...
            <div className="def">Refers to the year in which a document was first published. Note - this may not be year of the most recent update or amendment to a document.</div>
          </div>
          <div className="row">
          ...
          <div className="row">
            ...
            <div className="def">
              Documents are labelled based on how their content relates to the broad aspects of climate action defined as Mitigation, Adaptation, Disaster Risk Management and Loss
              &amp; Damage. For more information about these terms, please see the 'Responses' section of the{" "}
              <ExternalLink url="https://climate-laws.org/methodology-legislation">CCLW methodology</ExternalLink>.
            </div>
          </div>
          <div className="row">
