...
const LandingSearchForm = ({ placeholder, input, handleSearchInput }: SearchFormProps) => {
  ...
  const wrapperCssClass = site === "cpr" ? "text-white" : "text-indigo-400";
  ...
  const buttonCssClass = site === "cpr" ? "absolute top-0 right-0 -mt-1" : "absolute right-0 h-full pr-2 text-grey-700";
