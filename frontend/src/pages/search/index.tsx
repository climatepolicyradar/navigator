        ...
        >
          <div onClick={handleDocumentClick}>
            <Slideout
              ref={slideoutRef}
              show={showSlideout}
              setShowSlideout={resetSlideOut}
            >
              <div className="flex flex-col h-full relative">
                <DocumentSlideout
                  document={document}
                  searchTerm={searchCriteria.query_string}
                  showPDF={showPDF}
                ...
                <div className="flex flex-col md:flex-row flex-1 h-0">
                  <div
                    ...
                    } md:block md:w-1/3 overflow-y-scroll`}
                  >
                    <PassageMatches
                      document={document}
                  ...
                  <div
                    ...
                    } md:block md:w-2/3 mt-4 px-6 flex-1`}
                  >
                    <EmbeddedPDF
                      document={document}
            ...
            {showSlideout && (
              <div className="w-full h-full bg-overlayWhite fixed top-0 z-30" />
            )}
            <section>
