...
@patch('app.load.main.get_language_id')
@patch('app.load.main.get_geography_id')
@patch('app.load.main.get_type_id')
@patch('app.load.main.post_action')
def test_load(mock_post_action, mock_get_type_id, mock_get_geography_id, mock_get_language_id):
    ...
    doc: Doc = Doc(doc_url='http://doc', doc_name='doc name', doc_language='en', )
    ...
    mock_get_language_id.assert_called_once_with(doc.doc_language)
