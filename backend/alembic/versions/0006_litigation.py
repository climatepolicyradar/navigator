...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("lit_document_id", sa.Integer(), nullable=True),
        sa.Column("case_id", sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["lit_document_id"],
            ["lit_document.id"],
            name=op.f("fk_lit_event__lit_document_id__lit_document"),
        ),
    ...
    op.create_unique_constraint(
        op.f("uq_geo_statistics__name"), "geo_statistics", ["name"]
    )
    op.create_foreign_key(
        op.f("fk_geo_statistics__geography_id__geography"),
        "geo_statistics",
        "geography",
        ["geography_id"],
        ["id"],
...
def downgrade():
    ...
    op.drop_constraint(
        op.f("uq_geo_statistics__name"), "geo_statistics", type_="unique"
    )
