...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['parent_id'], ['geography.id'], name=op.f('fk_geography__parent_id__geography')),
    ...
    sa.ForeignKeyConstraint(['category_id'], ['category.id'], name=op.f('fk_document__category_id__category')),
    sa.ForeignKeyConstraint(['created_by'], ['user.id'], name=op.f('fk_document__created_by__user')),
    sa.ForeignKeyConstraint(['geography_id'], ['geography.id'], name=op.f('fk_document__geography_id__geography')),
    sa.ForeignKeyConstraint(['source_id'], ['source.id'], name=op.f('fk_document__source_id__source')),
    sa.ForeignKeyConstraint(['type_id'], ['document_type.id'], name=op.f('fk_document__type_id__document_type')),
    sa.ForeignKeyConstraint(['updated_by'], ['user.id'], name=op.f('fk_document__updated_by__user')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_document')),
    sa.UniqueConstraint('name', 'geography_id', 'type_id', 'source_id', 'source_url', name=op.f('uq_document__name'))
    )
    ...
    sa.Column('description', sa.Text(), nullable=False),
    sa.Column('source_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['parent_id'], ['instrument.id'], name=op.f('fk_instrument__parent_id__instrument')),
    sa.ForeignKeyConstraint(['source_id'], ['source.id'], name=op.f('fk_instrument__source_id__source')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_instrument')),
    sa.UniqueConstraint('name', 'source_id', 'parent_id', name=op.f('uq_instrument__name'))
    )
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], name=op.f('fk_password_reset_token__user_id__user')),
    ...
    sa.Column('description', sa.Text(), nullable=False),
    sa.Column('source_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['parent_id'], ['sector.id'], name=op.f('fk_sector__parent_id__sector')),
    sa.ForeignKeyConstraint(['source_id'], ['source.id'], name=op.f('fk_sector__source_id__source')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_sector')),
    sa.UniqueConstraint('name', 'source_id', 'parent_id', name=op.f('uq_sector__name'))
    )
    ...
    sa.Column('name', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['document_id_from'], ['document.id'], name=op.f('fk_association__document_id_from__document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['document_id_to'], ['document.id'], name=op.f('fk_association__document_id_to__document'), ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_framework__document_id__document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['framework_id'], ['framework.id'], name=op.f('fk_document_framework__framework_id__framework')),
    ...
    sa.Column('document_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_hazard__document_id__document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['hazard_id'], ['hazard.id'], name=op.f('fk_document_hazard__hazard_id__hazard')),
    ...
    sa.Column('document_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_instrument__document_id__document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['instrument_id'], ['instrument.id'], name=op.f('fk_document_instrument__instrument_id__instrument')),
    ...
    sa.Column('document_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_keyword__document_id__document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['keyword_id'], ['keyword.id'], name=op.f('fk_document_keyword__keyword_id__keyword')),
    ...
    sa.Column('document_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_language__document_id__document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['language_id'], ['language.id'], name=op.f('fk_document_language__language_id__language')),
    ...
    sa.Column('document_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_response__document_id__document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['response_id'], ['response.id'], name=op.f('fk_document_response__response_id__response')),
    ...
    sa.Column('document_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_document_sector__document_id__document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['sector_id'], ['sector.id'], name=op.f('fk_document_sector__sector_id__sector')),
    ...
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_event__document_id__document'), ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['document_id'], ['document.id'], name=op.f('fk_passage__document_id__document'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['language_id'], ['language.id'], name=op.f('fk_passage__language_id__language')),
    sa.ForeignKeyConstraint(['parent_passage_id'], ['passage.id'], name=op.f('fk_passage__parent_passage_id__passage')),
    sa.ForeignKeyConstraint(['passage_type_id'], ['passage_type.id'], name=op.f('fk_passage__passage_type_id__passage_type')),
